...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('migapis@hotmail.com', 'eternidade');
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'migapis@hotmail.com'
$ReportEmail.To.Add('migapis@hotmail.com')
